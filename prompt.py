...
def prompt_analyzer(input, today, timezone=None, event_draft=None, latest_conversations=None, event_list=None):
    ...
    If there are no events that span the entire day and no transparent events, you do not need to add a remark, unless there are other important notes to be added as remark.
    ...
    *Mon, 19 May 2025:*
    - 10:00 AM - 12:00 PM
    - 2:00 PM - 4:00 PM
    Please note that the events "A" and "B" span the entire day but are marked as transparent, meaning they do not block your availability. Therefore, I have not considered them as blocking your time.
...
def prompt_finder(input, today, timezone=None, event_draft=None, latest_conversations=None, event_list=None):
    ...
    You will answer user's question and return the event details in bullet point list and human-readable whatsapp-friendly format (use one asterisk for bold), which includes the event name, start and end times, location, description, and participants, unless user asks for more details.
